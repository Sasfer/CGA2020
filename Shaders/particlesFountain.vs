...
out float Transp;  // Transparency of the particle, cada detrminado tiempo la partícula debe desaparecer. 
...
void main()
{
    ...
    if( Time > StartTime ) {
        ...
        if( t < ParticleLifetime ) {
            pos = VertexInitVel * t + Gravity * t * t;// Creación del tiro parabólico 
            Transp = 1.0 - t / ParticleLifetime;// all conocer la posicion  la transposición. 
        }
    }
